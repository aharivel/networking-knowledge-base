...
+----------------+----------------+----------------+----------------+
| Ver (2) | Opt Len (6) | OAM (1) | Critical (1) |  Reserved (8)  |
+----------------+----------------+----------------+----------------+
| Protocol Type (16) | Reserved (8) | TLV Options (variable) |
+----------------+----------------+----------------+----------------+
|  Inner Ethernet|       Payload        |       FCS       |
|   Header (14)  |       (46-1500)       |       (4)       |
+----------------+----------------+----------------+----------------+
...
GRE Header:
+----------------+----------------+----------------+
| C (1) | R (1) | K (1) | S (1) | Recur (3) | Flags (5) | Ver (3) |
+----------------+----------------+----------------+
| Protocol Type (16) | Checksum (16) | Offset (16) |
+----------------+----------------+----------------+
| Key (32) | Sequence Number (32) |
+----------------+----------------+----------------+
